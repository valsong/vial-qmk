...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     [2] = LAYOUT(
        ...
        MAGIC_NO_GUI,  _______,      RGB_RMOD,    RGB_HUD,     RGB_SAD,     RGB_VAD,     RGB_SPD,     NK_TOGG,     _______,     _______,    _______,      _______,      _______,    _______,            _______,
        MAGIC_SWAP_LALT_LGUI,MAGIC_UNNO_GUI,MAGIC_UNSWAP_LALT_LGUI,         _______,                                                        _______,      _______,      _______,    _______,            _______
        ),
